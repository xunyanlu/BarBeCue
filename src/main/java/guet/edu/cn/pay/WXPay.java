package guet.edu.cn.pay;

import guet.edu.cn.sdk.WXPayUtil;
import guet.edu.cn.ulit.DateUtil;
...
public class WXPay {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 商家扫用户手机的条形码
        // scanCodeToPay("");
        // scanCodeToPay("130235734201853319");
    }
    ...
    public static String scanCodeToPay(String auth_code) throws Exception {
        ...
        guet.edu.cn.sdk.WXPay wxpay = new guet.edu.cn.sdk.WXPay(config);
    ...
    下单：生成二维码
     */
    public static void unifiedOrder(String body, int total_fee) {
        Map<String, String> resultMap = new HashMap();
        String openid = "ouR0E1oP5UGTEBce8jZ_sChfH26g";
        MyConfig config = null;
        guet.edu.cn.sdk.WXPay wxpay = null;
        try {
            config = new MyConfig();
            wxpay = new guet.edu.cn.sdk.WXPay(config);
        } catch (Exception e) {
            e.printStackTrace();
        }
        //生成的随机字符串
...
//        data.put("attach","id,11111;price,18.00;amount,1;");
        ...
        try {
            Map<String, String> rMap = wxpay.unifiedOrder(data);//调用统一下单接口
            System.out.println("统一下单接口返回: " + rMap);
            createQRCode(rMap);//根据官方返回的数据去生成二维码
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void createQRCode(Map<String, String> map) throws Exception {
        ...
        File outputFile = new File(projectPath + "/pay.jpg");
